...
function showProToolsMenu() {
  ...
  ui.createMenu('🚀 Pro Tools')
    ...
    .addSubMenu(ui.createMenu('🎬 Production')
      ...
      .addItem('🎞️ Event Slideshow', 'showEventSlideshow'))
    .addSubMenu(ui.createMenu('📅 Schedule')
      .addItem('🕐 Update Time Calculations', 'updateScheduleTimes')
      .addItem('📅 Add Day Separator', 'showDaySeparatorDialog')
      .addItem('🧪 Test Schedule Structure', 'testSimplifiedSchedule'))
    .addSubMenu(ui.createMenu('✉️ Communication')
      .addItem('📝 Form Templates', 'setupFormTemplatesSheet')
      .addItem('🔗 Generate Forms', 'showFormSelectionDialog')
      .addItem('📧 Send Emails', 'showEmailDialog'))
    .addSubMenu(ui.createMenu('📄 Blank Sheets')
      .addItem('Budget', 'setupBudgetSheet')
      .addItem('Logistics', 'setupLogisticsSheet')
      .addItem('Cue Builder', 'setupCueBuilderSheet')
      .addItem('Form Templates', 'setupFormTemplatesSheet')
